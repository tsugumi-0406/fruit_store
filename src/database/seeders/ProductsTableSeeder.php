...
class ProductsTableSeeder extends Seeder
{
     ...
     public function run()
    {
        ...
        $season1 = Season::where('name', '秋')->first();
        $season2 = Season::where('name', '冬')->first();

        $product->seasons()->attach([$season1->id, $season2->id]);
        ...
        $season1 = Season::where('name', '春')->first();

        $product->seasons()->attach([$season1->id]);
        ...
        $season1 = Season::where('name', '冬')->first();
        ...
        $season1 = Season::where('name', '夏')->first();
        ...
        $season1 = Season::where('name', '夏')->first();
        $season2 = Season::where('name', '秋')->first();
        ...
        $season1 = Season::where('name', '春')->first();
        $season2 = Season::where('name', '夏')->first();
